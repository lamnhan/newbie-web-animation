...
export default function Emojis() {
  ...
  function animateHaha() {
    ...
    const timeline = newTimeline({ duration: 0.15 }, { repeat: 2 });
    [
      [-2, 2],
      [-4, 1],
      [-6, 0],
  ...
  return (
    <>
      <ul className={styles.reactionsList}>
          ...
          <svg id="like" viewBox="0 0 60 60">
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor="rgba(54,181,255,1)"
                  stopOpacity="1"
                />
                <stop
                  offset="100%"
                  stopColor="rgba(0,106,255,1)"
                  stopOpacity="1"
                />
              </linearGradient>
            </defs>
        ...
        <li className={styles.loveContainer}>
          <svg id="love" viewBox="0 0 60 60">
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor="rgba(255,54,120,1)"
                  stopOpacity="1"
                />
                <stop
                  offset="100%"
                  stopColor="rgba(255,0,63,1)"
                  stopOpacity="1"
                />
              </linearGradient>
            </defs>
        ...
        <li className={styles.hahaContainer}>
          <svg id="haha" viewBox="0 0 60 60">
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor="rgba(255,234,54,1)"
                  stopOpacity="1"
                />
                <stop
                  offset="100%"
                  stopColor="rgba(255,164,0,1)"
                  stopOpacity="1"
                />
              </linearGradient>
              <linearGradient
              ...
              >
                <stop
                  offset="0%"
                  stopColor="rgba(130,87,2,1)"
                  stopOpacity="1"
                />
                <stop
                  offset="100%"
                  stopColor="rgba(179,127,33,1)"
                  stopOpacity="1"
                />
              </linearGradient>
              <linearGradient
